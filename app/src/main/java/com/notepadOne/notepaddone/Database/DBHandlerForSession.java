package com.notepadOne.notepaddone.Database;
...
import com.notepadOne.notepaddone.ContactsSession;

import java.util.ArrayList;
import java.util.List;

public class DBHandlerForSession extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "contactsManager223";
    private static final String TABLE_CONTACTS = "contacts223";
    ...
    public DBHandlerForSession(Context context) {
    ...
    public void addContact(ContactsSession contact) {
    ...
    ContactsSession getContact(int id) {
        ...
        ContactsSession contact = new ContactsSession(Integer.parseInt(cursor.getString(0)),
                cursor.getString(1), cursor.getString(2), cursor.getString(3));
        return contact;
    }

    // code to get all contacts in a list view
    public List<ContactsSession> getAllContacts() {
        List<ContactsSession> contactList = new ArrayList<ContactsSession>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ContactsSession contact = new ContactsSession();
    ...
    public int updateContact(ContactsSession contact) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteContact(ContactsSession contact) {
        SQLiteDatabase db = this.getWritableDatabase();
