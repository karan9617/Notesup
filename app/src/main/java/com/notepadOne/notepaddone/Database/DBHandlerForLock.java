...
import com.notepadOne.notepaddone.ContactsForLock;
...
public class DBHandlerForLock extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "contactsManager22355";
    private static final String TABLE_CONTACTS = "contacts22355";
    ...
    public DBHandlerForLock(Context context) {
    ...
    public void addContact(ContactsForLock contact) {
    ...
    ContactsForLock getContact(int id) {
        ...
        ContactsForLock contact = new ContactsForLock(Integer.parseInt(cursor.getString(0)),
                cursor.getString(1), cursor.getString(2), cursor.getString(3));
        return contact;
    }

    // code to get all contacts in a list view
    public List<ContactsForLock> getAllContacts() {
        List<ContactsForLock> contactList = new ArrayList<ContactsForLock>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ContactsForLock contact = new ContactsForLock();
    ...
    public int updateContact(ContactsForLock contact) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteContact(ContactsForLock contact) {
        SQLiteDatabase db = this.getWritableDatabase();
