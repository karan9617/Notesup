package com.notepadOne.notepaddone.wallet;
...
//
//
public class DBHandlerForColors extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "contactsManager2129";
    private static final String TABLE_CONTACTS = "contacts2129";
    ...
    public DBHandlerForColors(Context context) {
